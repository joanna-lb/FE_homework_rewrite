  ...
  return (
    <>
      <div className="fliter">
        <div className="btns">
          <button type="button" className={activeStyle === ALL ? 'active' : ''} onClick={() => handleClick(ALL)}>All
          </button>
          <button type="button" onClick={() => handleClick(PHYSICAL)}
                  className={filterType === PHYSICAL ? 'active' : ''}>Physical
          </button>
          <button type="button" onClick={() => handleClick(VIRTUAL)}
                  className={filterType === VIRTUAL ? 'active' : ''}>Virtual
          </button>
        </div>
